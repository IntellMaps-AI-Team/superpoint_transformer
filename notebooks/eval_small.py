...
# filepath = '/home/data/assets/COOP/2NP_nocolours.las'
...
#%%
from src.transforms import instantiate_datamodule_transforms, NAGRemoveKeys
...
print("Data transformed on device")
...
# Save the semantic segmentation predictions in the LAS file
las['classification'] = raw_semseg_y.cpu().numpy()
las.write(out_path)
print("Output saved")
